...
export default function SignUp() {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      TechStackinput: Yup.string(),
      LinkedInGitHubURL: Yup.string().required(
        "LinkedIn/GitHub URL is required"
      ),
      ...
      <div className="login-card">
        ...
        <form onSubmit={formik.handleSubmit} className="login-form">
          ...
          <div className="input-group">
            ...
            <input
              ...
              id="TechStackinput"
              name="TechStackinput"
              placeholder="Enter your tech stack (e.g., React, Node.js)"
              value={formik.values.TechStackinput}
              onChange={formik.handleChange}
              disabled={formik.isSubmitting}
            />
            {formik.touched.TechStackinput && formik.errors.TechStackinput && (
              <div className="error-msg">{formik.errors.TechStackinput}</div>
            )}
          </div>
          <div className="input-group">
            <label htmlFor="LinkedInGitHubURL">LinkedIn/GitHub URL</label>
            <input
              type="text"
              id="LinkedInGitHubURL"
              name="LinkedInGitHubURL"
              placeholder="Enter your LinkedIn or GitHub URL"
              value={formik.values.LinkedInGitHubURL}
              onChange={formik.handleChange}
              disabled={formik.isSubmitting}
            />
            {formik.touched.LinkedInGitHubURL &&
              formik.errors.LinkedInGitHubURL && (
        ...
        <div className="login-footer">
          <p className="signup-redirect">
            ...
            <Link to="/section/developerLogin">Log In</Link>
          </p>
        </div>
      </div>
    </div>
